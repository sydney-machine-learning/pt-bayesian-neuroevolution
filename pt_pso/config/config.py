...
parser.add_argument('--burn-in', type=float, default=.10, help='Ratio of samples to be discarded as burn-in samples. Value 0.1 means 10 percent samples are discarded')
